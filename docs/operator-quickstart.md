# Operator Quickstart — Activities of religious organizations

Shortest path from clone to a verified local dry-run for **ISIC 9491** (`cloud-itonami-isic-9491`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-9491.git
cd cloud-itonami-isic-9491
```
...
- Blueprint governor key: `congregational-governance-governor`
- Likely source path: `congregation.governor.cljc`
